...
public class GameManager6 : MonoBehaviour {
	...
	if(PlayerPrefs.GetInt("HighScore6")<PlayerPrefs.GetInt("Score6"))
	PlayerPrefs.SetInt("HighScore6",PlayerPrefs.GetInt("Score6"));
	PlayerPrefs.SetInt("Start",0);
	SceneManager.LoadScene(15);
	}
	...
	if(col.gameObject.tag=="Win")	//碰觸到Win標籤
		GetComponent<GameManager6>().Win();  //獲得GameManager內的Win函數
